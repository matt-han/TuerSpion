...
%In Kapitel drei wird die Android App beschrieben und auf dessen Funktionalitäten eingegangen. Auf Desktop App wird in Kapitel vier genauer eingegangen.

Um ein besseren Überblick des Projektes zu haben befindet sich im Anhang \ref{A.überblick} eine Übersicht der Komponenten und Struktur des Projektes.